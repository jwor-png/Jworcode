# Revenue Streams — Portfolio Tracker

This file is the shared brief between **Cuan** (this orchestration layer) and the
dedicated **Revenue Streams** chat thread. Cuan reads this file in full at all
times and stays fully informed on every stream — the dedicated thread does the
deep specialist work and writes status back here so nothing is lost between
sessions.

John owns and directs all of these. Cuan orchestrates awareness across them.
...
10. ~~Confirm the Portlaoise business name~~ **RESOLVED, 18 Sept - the
   ...
   different matter, same location, no assumed connection.) Still open:
...
- **Tina O'Hagan** — John to talk to her about running the training course
  and getting introduced to the companies she works with. **Resolved, 19
  Sept 2026 — one person, mix-up cleared:** the earlier "Portugal, Malachy
  connection" note conflated two separate things. **Malachy Harkin was
  himself an early Golden Generation member but didn't finish the
  programme.** Tina O'Hagan is a separate person — a Tangible Ireland
  Group colleague who **did complete Golden Generation and was active
  throughout, both before and after** — specialises in sales, and per
  John "owes Shane and I a lot of favours." She operates in **Northern
  Ireland**, which is now the confirmed, actionable detail — the Portugal
  reference no longer applies to her.
...
- **Co-owner note:** John Lynch is a joint owner of the Julianstown site
  separately (property/financial position tracked in `operating_creed.md` —
  balance €8,000 as of 28 July, distinct from the planning matter below).
- **Status:** Meath County Council planning decision due **Tuesday 4 August
  2026**. Sole objection on file from Fred Logue; planning consultants (Stephen
  Ward & Co, Oppermann Associates) have rebutted his objection as inaccurate
  (access road/car park pre-1963, exempt from planning).
- **Political engagement:** Outreach to elected representatives — Cllr Sharon
...
## 2. UHL Hardware (United Hardware Limited)
- **What it does:** Ireland's leading buying/marketing group for builders'
  merchants, DIY, home and garden retail. Homevalue brand. 137 members, 199
  trading locations.
- **John's role:** Independent Non-Executive Director, Chair of Audit & Risk
  Committee.
- **This is a board/governance role, not a direct revenue-generating venture for
  John** — tracked here because it carries fee income (July invoice sent) and
  material time commitment. Full governance detail (board papers, Mazars audit,
  risk register) lives in `operating_creed.md` under Protect My Present
  Responsibly.
- **Fee income:** Monthly invoice to Nicola/Dave — July invoice sent, awaiting
  payment.

## 3. Ambrion AI
- **What it does:** John's primary AI company — governance advisory and EU AI
  Act compliance for Irish SMEs.
- **Current focus:** Tiered done-for-you EU AI Act compliance offering.
...
- **This stream connects to Meridian's own separate, dedicated system** — full
  depth, strategy, and client work happens there, not here. This entry is the
  stream-level status card only.
...
- **Status (as of 29 July Portlaoise meeting):** Shane made changes to the
  Meridian structure — detail to be dictated by John. Launch plan still to be
  built.
- **Live thread:** Marie O'Donnell introduction drafted, needs her email address
  to send.
- **Fee structure:** Still being located from a previous conversation.
- **Funding landscape intelligence and market intelligence log** (full detail):
  see `ventures_dossier.md`.

## 5. Golden Generation
- **What it is:** Worker/AI upskilling programme, partner model tied to
  Meridian, also a LinkedIn content series ("Other Side of Sixty" / JWOR
  Publishing System — John records voice notes, structured into finished posts).
...
- **What it does:** Vehicle for partner and channel relationships in John's AI
  stack.
- **Key relationships:** Mairead O'Donnell (Claochlu Consulting) — background
  collaboration, Mairead stays front-facing to her clients; Vinny Leonard (Sales
  Process Advisors) — co-creation channel partner model.
...
## 7. ODIN
- **What it is:** Investment/fundraising vehicle, distinct from Tairseach
  (Shane's property intelligence company) though moving in the same investor
  circle.
- **Live thread:** Mark Finlay Zoom call held (28 July evening, John and Shane)
  regarding introductions to US-based ODIN investors — awaiting Mark's
  follow-up.
...
- **John's role:** Commercial Lead via Velocity AI / Meridian Intelligence —
  advisory only, no operational role, will not relocate.
- **Shane's role:** Technical lead, advisory only.
- **Johnny Shanahan:** Founding industry authority, primary operator, based
  Manchester with regular London presence.
- **Confidentiality:** John and Shane's names are not on Johnny-facing documents.
- **Live thread:** Build scope proposal completed by Shane, sent to Johnny,
...
- **Recommended structure:** UK limited company registered in London.
- **Funding modelled:** Two-tranche raise of £125,000–£200,000.

---

## Open Naming/Structure Questions
- Confirm exact spelling of the investor Johnny Shanahan introduced ("Eight
  North" heard, unconfirmed).
- Confirm whether Sales Orchestration is formally renamed to Revenue Streams,
  or whether Revenue Streams sits as a function within a renamed Sales
