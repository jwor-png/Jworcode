...
| 2026-09-20 | Instagram/Threads (@yourclaudehacks) | Prompt template — "Strategic Growth Plan" | A shared Claude prompt, tagged "Prompt 8" in a numbered series: "Act as a business strategy consultant. My business currently makes [amount] from [describe]. I want to reach [target revenue] in [timeframe]. Build me a complete strategic growth plan - the revenue levers to pull, the markets to enter, the offers to add, and the single constraint I need to break through first before anything else will work." Notable for forcing a single named constraint rather than a generic list of opportunities - directly usable structure for reviewing any of John's own revenue streams (UHL, Barber Republic, Ambrion) against, or for the Intelligence Concierge product's own prompt library. **Not independently tested or verified as effective** - logged as a technique to try, not a validated method. | Cuan (own working method); Intelligence Concierge product |
