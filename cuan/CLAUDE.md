...
| `institutional_memory_offer_concept.md` | Exploratory, uncosted offer concept (renamed from "Golden Generation" 18 Sept 2026 to remove a naming clash — see below) — AI-assisted capture of an owner's undocumented institutional knowledge for succession-facing SMEs, still needs its own permanent name |
