# AHL — Smyths of Killucan Product Claim: Summary for Meridian / Jürgen Review

Prepared by Cuan, 2 September 2026. Status: DRAFT — for legal/governance
review before any email is sent. Not yet reviewed by Meridian or Jürgen.

## Background

AHL Plc (John is Chairman) has an outstanding product-liability claim
from **Smyths of Killucan Homevalue Hardware** (T.L O'Callaghan Ltd,
Killucan, Mullingar, Co. Westmeath), raised by **Ray Smyth**
(rsmyth@smythskillucan.ie / accounts@smythskillucan.ie).
...
Paul Candon (UHL CEO) notes: *"In Smyths case it appears that the
customer has not taken any action against Smyths, so I have my
reservations about what's going on!"* — i.e. a live question of whether
this claim is a genuine third-party dispute or leverage against AHL's
own debt collection.

**The precedent relied on:** Mark Doherty (Marsh Ireland) wrote to Paul
Candon, 28 June 2024, re *Conway v Mulvey Homevalue / United Hardware /
Northstone* — the Sedgwick loss adjuster for Northstone stated the
product (white limestone sand) was a proprietary raw material supplied
with no stipulation as to end use, no guarantee of fitness as a render,
not advocated for that purpose, no knowledge of the mix/process used,
and no evidence of negligence. Marsh advised UHL to extract itself, the
product never having been on UHL's own premises. **Caveat: that
correspondence concerns the Mulvey matter specifically — whether it
carries across to the Smyth claim depends on the product and supply
route being the same, which has not been independently confirmed.**
...
> Hi Ray,
>
> Thank you for your email and I have now put this fully to the AHL Board.
>
> Having reviewed the matter in full, including the position taken with
> United Hardware previously on the comparable Mulvey matter, AHL does
> not accept responsibility or culpability for the claim as put to us.
> The figure quoted has moved from €70,000 to €90,000 within a matter of
> weeks without supporting detail or justification, and it remains
> unclear on what basis AHL is held responsible for a claim that, as I
> understand it, your customer has not themselves pursued formally
> against Smyths.
>
> The product supplied was a proprietary raw material, supplied with no
> stipulation as to end use and no guarantee of fitness for the specific
> application it was used for. That has already been the position taken
> in the comparable matter, and it applies equally here.
>
> This is separate from, and does not affect, the account currently
> outstanding to AHL, which remains due.
>
> I'm happy to discuss further if it would help, but I wanted you to
> have the Board's position clearly and in writing.
>
> Best regards
> John
...
1. Does the Marsh/Mulvey precedent (proprietary raw material, no
