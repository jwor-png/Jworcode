# Family Genealogy & DNA — Webb / O'Rourke

Personal/family reference, not business. Logged here as John shares more —
"more to follow" as of 1 Sept 2026.

## DNA results found

**No completed MyHeritage DNA test/results for John himself found in his
Gmail** — despite years of MyHeritage marketing emails (2019-2026) and a
brand-new "Welcome to MyHeritage!" signup email (1 Sept 2026, 21:57),
there is no order confirmation or results email in this inbox. Possible
...
side (Webb or O'Rourke) traces to which heritage group:
- Irish, Scottish and Welsh — **71.0%** (subgroup: Southwestern Ireland
  and England, 71.0% — Irish and some English in SW Ireland/England, with
  descendants in Australia and the US, notably New York and
  Massachusetts)
- East European — **12.4%**
- English — **13.0%**
- Scandinavian — **2.6%**

Marion-Jane's own words: "I find it very interesting to see where our
heritage has come from... thought we could compare the results to see
which was mam's side and which might have been the Webbs and the
O'Rourkes sides."

## Webb Surname DNA Project (older, separate thread — 2013)

A distinct, older genealogy project — the **Webb Surname DNA Project**,
run by **Eileen Sturner** (esturner@casco.net), with US-based **Sean Webb**
(seanwebb1@gmail.com) corresponding about it in September 2013.

Sean Webb's update: his own upgraded DNA test hadn't matched any lineage
in the project's mainly US/English Webb DNA family group strains. His
suggestion: rather than John testing directly (which would only link the
existing correspondents to each other, not add new information), it would
be more useful for **a known Irish Webb relative who is NOT closely
related to Sean/this group** to test — that would give a real chance of
finding a connection to another Webb lineage group not yet in the
project's files, and tracing their family tree back might reveal a
