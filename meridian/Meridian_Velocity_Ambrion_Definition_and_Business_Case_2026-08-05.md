...
The single most important row in that table is "is the buyer thinking about AI." Velocity's and Ambrion's buyers are. **Meridian's buyer is not.**

Anthony Hennessy was thinking about gas cylinders. John Lynch was thinking about what his business is worth. Fleming Medical's board was thinking about a capital event. Johnny Shanahan was thinking about a fifty thousand pound investor. United Hardware's ARC was thinking about whether an audit was sound.

None of them wanted AI. All of them wanted an answer.

That is why Meridian does not compete with Velocity or Ambrion. It reaches a buyer neither of them can reach, at a moment neither of them is present for.
...
**The four situations it is bought for**, all evidenced by delivered work:

1. **A capital event.** Raising, selling, taking an investor, choosing an instrument. *Barber Republic, Fleming Medical, Arcade Trader.*
2. **A category or expansion move.** Should we enter this, buy this, form this. *Stargas cylinder testing, United Hardware paint buying group, United Hardware garden centre.*
3. **A governance question with teeth.** Audit soundness, directors' exposure, vendor challenge. *United Hardware ARC, 2025 audit review.*
4. **A proposition that needs verifying before it is backed.** *UroPharma, Mike Molloy assessment.*

**The proof, already delivered.** Nine engagements, all filed with reasoning intact:
...
| United Hardware | Form a paint buying group? | Validation brief, verification pack, location addendum, formal response to Candon's review |
...
| Barber Republic | What instrument for Ed Lawton's £50k? | Funding ladder, dilution modelling, two scenarios, rollout roadmap. Converged independently with Shane's own founder documents |
| Export Anatolia | How do we adopt AI? | Seven-manager briefing *(note: this one belongs to Velocity, see below)* |
...
Eight of the nine are decision briefs. One, Export Anatolia, is an AI adoption job that should have gone to Velocity. That is the only misplacement in the book, and it is instructive.

---

## VELOCITY AI — the definition

**What it is.** The operator. Shane's brand. Builds and deploys AI at scale, in the client's business, alongside the client's team.

**Its own words, verified from velocityai.ie:** *"We are not consultants. We are operators who build and deploy AI at scale."* *"We diagnose where AI will hit your business first, then we build the response."*

**The offer, verified from the EDelia proposal, June 2026.** Phase One, AI-Native Readiness, three months, €30,000 + VAT at €10,000 per month: orchestration engines embedded across the client's core team, two to three proprietary proof points built and branded for the client, a governance baseline, five team sessions and two CEO sessions, readiness diagnostics. Phase Two, AI-Native Build, full architecture and company-wide integration, costed at the end of Phase One.

**Live front-of-site tools:** Strategic Clarity Diagnostic, Live Strategic Simulator, 90-Second Strategic Brief. Four tiers of Migration Education: Leadership Teams, 1-to-1 Decision Makers, Board Advisory, Senior Management.

**Where it sits against Meridian.** Velocity is downstream of a decision that has already been made. The client has decided AI is the answer and needs it built. Meridian is upstream, at the moment the decision itself is still open, and usually about something other than AI.

**The genuine overlap, and it is narrow.** Velocity leads on the word "clarity" and on "we diagnose." That is diagnostic language and it brushes against Meridian. But Velocity diagnoses *where AI will hit the business*. Meridian diagnoses *whether to do the deal*. Same verb, different object.
...
## WHERE THEY COLLIDE, AND THE FIX

Three collisions. All three are fixable and none of them are structural.
...
> **Fix: Manager 5 stays in the engine, comes off the shopfront.** Meridian keeps the domain because decisions sometimes touch AI and the analysis needs it. Meridian stops selling it. Export Anatolia-shaped enquiries route to Velocity.
...
## THE REFERRAL FLOW — the overlap turned into a channel
...
*Expanded against Shane's four questions.*
...
Owners, chairs and boards of Irish and UK mid-market businesses, roughly €5m to €100m turnover, facing a decision worth at least two orders of magnitude more than the fee, in one of the four situations above.

The qualifying question is a single sentence: *is there a decision on your desk right now that is too expensive to get wrong and too broad for any one adviser?*
...
**Funding offsets already identified:** Skillnet Ireland, Enterprise Ireland Innovation Vouchers up to €5,000.

## 4. What is defensible — and where the AI expertise actually sits

This is the section that answers Shane's hardest point, and it is where the AI claim belongs. **The rarity is not that Meridian knows about AI. It is that Meridian has built and operates a governed multi-domain AI intelligence engine, and a serving PLC chair signs its output.** Almost nobody has both halves.

Four layers, weakest to strongest.

**Layer one: the parallel-domain method.** Seven senior domains interrogated simultaneously over the same question, then consolidated into one position. Fleming Medical is the proof: seven domains, eight to ten interrogated questions each, consolidated into an executive brief with five risks, a four-programme recommendation and a human gate. A traditional firm takes weeks and charges multiples. Real advantage today, eroding over eighteen to thirty-six months as others build similar engines. Time-limited, so do not build the whole case on it.

**Layer two, and this is the rare one: the verification discipline.** Every AI-generated claim is checked against source and labelled verified, estimated or unverified before it reaches a client. Nothing unsourced. Nothing presented as fact that is not. This is already the standing rule and it is visible in the work: the Mike Molloy assessment was held pending proof rather than sold as verified; the Fleming Medical brief corrected Meridian's *own* earlier optimistic scoring; the Export Anatolia sector description was corrected on record from castings to agricultural machinery parts.

> That is the differentiator almost nobody else will have. The market is about to be flooded with confident, plausible, unverifiable AI analysis. Meridian's product is analysis a board can rely on and a director can sign against. **The discipline is the product. The AI is the engine.**

Very few will have this because it is expensive and unglamorous. It requires someone who knows what a board will not accept, and who is willing to slow the machine down and mark a claim unverified when it would read better as fact. That is a governance instinct, not a technical one, and it comes from forty years of sitting where the liability lands.

**Layer three: access that cannot be copied.** John chairs AHL PLC. He is Independent Non-Executive Director and Chair of the Audit and Risk Committee at United Hardware. Four decades of board relationships across commercial, property, healthcare, governance and capital. This is why Meridian is in the room where the decision is made, not the room where a report is received. A competitor can copy the method in a year. They cannot copy forty years of being trusted by the people who own the decision.

**Layer four, the compounding one: the corpus.** Nine engagements are filed with their reasoning intact, and every new one adds a decision pattern to a body of Irish and UK mid-market precedent that only Meridian holds. Barber Republic proved its worth directly: Meridian's analysis and Shane's independently written founder documents converged on the same instrument, and that convergence is what gave the recommendation its authority. In three years this corpus is the asset, and it is what makes Meridian saleable rather than merely billable.

## 5. Capacity

The product is a fixed-scope written brief, not open-ended advisory days. The engine does production. John does review and judgment. That is a far higher ceiling than a conventional practice, and it is raised by adding senior reviewers who pressure-test a brief, not by finding another cross-disciplinary synthesiser.

Realistic today alongside existing board commitments: eight to twelve briefs a month. At line-one pricing that is a real business before a single retainer is signed.

## 6. What must change, in order

1. **Move the three AI products to Ambrion.** Meridian's price list becomes the decision brief and the retained seat.
2. **Take Manager 5 off the shopfront.** Keep it in the engine.
...
>
> **How it makes money.** Fixed-scope decision briefs, retained decision seats, and AI-for-equity structures.
>
