...
b+=[L('THE ONE LINE THAT DIVIDES THEM'), rule(),
 ...
 simple_table(['','MERIDIAN INTELLIGENCE','VELOCITY AI','AMBRION AI'],[
  ...
  ['<b>Verified pricing</b>','Decision Brief &euro;4,950, Executive Review &euro;24,500, Transaction Intelligence &euro;35,000, retained from &euro;4,500/mth','&euro;30,000 + VAT Phase One, 3 months, at &euro;10,000/month (EDelia, June 2026)','Tiered. Rates not yet on record'],
...
b+=[H('THE MERIDIAN BUSINESS CASE'), P('<i>Expanded against Shane&rsquo;s four questions.</i>'), rule(),
 ...
 P('<b>Line one, the decision brief.</b> Proven nine times. One decision, defined scope, written deliverable, days not weeks. It prices as a unit because it has a boundary. &euro;4,950 list, &euro;3,950 founding rate. Deliberately under &euro;5,000 so it sits inside a managing director&rsquo;s own signing authority.'),
 P('<b>Line two, the retained decision seat.</b> United Hardware is already this shape without being named as such: multiple decisions across a year, one board, standing access. This is where the durable revenue is because it removes the sell each time. Three tiers from &euro;4,500 to &euro;10,000 per month at list. Three at the middle tier is &euro;270,000 a year before a single brief is sold.'),
