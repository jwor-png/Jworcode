...
b+=[L('THE ONE LINE THAT DIVIDES THEM'), rule(),
 ...
 simple_table(['','MERIDIAN INTELLIGENCE','VELOCITY AI','AMBRION AI'],[
  ...
  ['<b>Ownership</b>','John 70 / Shane 30','Shane 70 / John 30','UNCONFIRMED, the only remaining gap'],
...
b+=[L('AMBRION AI &nbsp;&mdash;&nbsp; THE DEFINITION'), rule(),
 ...
 callout('<b>The one remaining UNCONFIRMED item:</b> the ownership split. Meridian&rsquo;s (John 70 / Shane 30) and Velocity&rsquo;s (Shane 70 / John 30) are on the record. Ambrion&rsquo;s is not. Given it is named as John&rsquo;s primary revenue vehicle for three years, this should be documented before anything else in the portfolio is formalised.', RED, HexColor('#FBEDEF')),
 PageBreak()]
...
b+=[L('5 &nbsp; CAPACITY'), rule(HexColor('#D5DDE3'),0.6),
 ...
 N(6,'<b>Draw the Meridian 70/30 shareholders agreement, and document Ambrion&rsquo;s split.</b> Meridian&rsquo;s is undrawn. Ambrion&rsquo;s is not even on the record, and it is the vehicle named as John&rsquo;s primary revenue source for three years. That is the more urgent of the two.'),
