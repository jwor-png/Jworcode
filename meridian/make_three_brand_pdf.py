...
b+=[L('THE ONE LINE THAT DIVIDES THEM'), rule(),
 ...
 simple_table(['','MERIDIAN INTELLIGENCE','VELOCITY AI','AMBRION AI'],[
  ...
  ['<b>Legal entity</b>','To be formalised','Mainly Velocity Limited, t/a Velocity AI','<b>None. Ambrion is a brand, not a company</b>'],
  ['<b>Generating income?</b>','Fee income from delivered briefs','Yes','<b>No. Governance work only to date</b>'],
  ...
  ['<b>Portfolio priority</b>','Complementary, and the upstream feeder','Shane-led build arm','<b>John&rsquo;s primary revenue vehicle for the next three years</b>'],
...
b+=[L('AMBRION AI &nbsp;&mdash;&nbsp; THE DEFINITION'), rule(),
 ...
 callout('<b>Status.</b> Highest priority revenue stream. The 2 August 2026 anchor is <b>now active</b>, not passed: it was the compliance campaign launch date. Live outreach in progress, including Glennon Brothers. <b>Ambrion is John&rsquo;s primary revenue vehicle for the next three years.</b>', TEAL),
 ...
 P('<b>Trading status: trading, but not currently generating income.</b> Work to date has been governance work only.'),
 P('<b>There is no legal Ambrion entity.</b> The United Hardware senior executive training was delivered under the Ambrion name because UHL already knew that name, but it was contracted and invoiced through the Velocity company, because there is nothing else to contract through.'),
 SUB('The flag that follows from that, and it needs acting on'),
 P('Three facts sit together uncomfortably:'),
 N(1,'Ambrion is named as John&rsquo;s <b>primary revenue vehicle for the next three years</b>.'),
 N(2,'Ambrion has <b>no legal entity</b>, so it cannot contract, invoice, hold a bank account, or own its own IP.'),
 N(3,'Ambrion-branded revenue therefore flows through <b>Mainly Velocity Limited, which is Shane 70 / John 30</b>, not Ambrion&rsquo;s Shane 60 / John 30 / Pat 10.'),
 P('The economic effect, if this continues, is that Ambrion revenue is earned under a split John did not agree for Ambrion, and Pat McGrath&rsquo;s 10 per cent has no vehicle to attach to at all. On the UHL training alone the difference is administratively small. Across a three-year primary revenue vehicle running a national EU AI Act compliance campaign, it is not small.'),
 callout('<b>This is not a suggestion that anyone intends anything other than the agreed position.</b> It is that the agreed position currently has nothing to sit in. The compliance campaign is live from 2 August. <b>Incorporating Ambrion, with the 60/30/10 recorded, is now the most urgent formality in the entire portfolio</b>, ahead of the Meridian shareholders agreement. Until it exists, every euro of Ambrion revenue lands in a Shane-majority company by default.', RED, HexColor('#FBEDEF')),
...
b+=[L('THE REFERRAL FLOW &nbsp;&mdash;&nbsp; THE OVERLAP TURNED INTO A CHANNEL'), rule(),
 ...
 SUB('The portfolio order, now that the briefing is in'),
 P('Ambrion is stated in its own briefing as John&rsquo;s primary revenue vehicle for the next three years, with a statutory deadline behind it and a live campaign running. <b>That settles the priority question, and Meridian&rsquo;s business case has to be built inside it, not alongside it.</b>'),
 P('Meridian is not competing for that first position and should not be positioned as if it were. Meridian earns its place three ways: it is the only vehicle that reaches a buyer who is not thinking about AI, it generates fee revenue on days rather than months, and it feeds the primary vehicle warm board-level introductions at the exact moment of receptiveness. That is a strong argument for building Meridian properly, and a poor argument for launching it ahead of Ambrion&rsquo;s compliance campaign.'),
 PageBreak()]
