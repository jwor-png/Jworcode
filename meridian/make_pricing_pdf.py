...
b+=[L('THE PRICING LOGIC &nbsp;&mdash;&nbsp; SAY THIS BEFORE ANY NUMBER'), rule(),
 P('Meridian is not priced on time. It is priced on <b>the consequence of the decision it is answering.</b>'),
 callout('<b>The rule: the fee sits roughly two orders of magnitude below the value of the decision.</b><br/>A &euro;500,000 decision earns a &euro;5,000 brief. A &euro;5m transaction earns a &euro;20,000 one.', TEAL),
 P('This is the sentence that does the selling, and the sentence that stops the conversation becoming a day-rate negotiation. If a client is weighing whether to spend &euro;4,500, the honest answer is that their decision is probably not big enough for Meridian yet, and saying so builds more trust than discounting.'),
 P('<b>The comparison that makes it obvious.</b> A mid-tier consultancy strategic review is &euro;40,000 to &euro;100,000 and takes six to twelve weeks. Meridian delivers a comparable depth of multi-domain analysis in days, at a fraction of that, because the analysis is produced by a governed engine and the senior time goes into judgment and verification rather than production.'),
 ...
 simple_table(['#','Product','What it answers','Scope','Turnaround','Founding','List'],[
  ['1','<b>Decision Brief</b>','One specific question','Up to 3 domains','5 working days','<b>&euro;3,750</b>','<b>&euro;4,950</b>'],
  ['2','<b>Executive Intelligence Review</b>','A whole situation, every angle','All 7 domains','10 working days','<b>&euro;9,750</b>','<b>&euro;12,950</b>'],
  ['3','<b>Transaction Intelligence</b>','Should we do this deal, on what terms','All 7, deal-grade','10 to 15 days','<b>&euro;15,000</b>','<b>&euro;19,500</b>'],
  ['4','<b>Intelligence Partner</b> (retained)','Everything, continuously','See tiers','Standing','<b>from &euro;2,750/mth</b>','<b>from &euro;3,750/mth</b>'],
...
b+=[L('2 &nbsp; EXECUTIVE INTELLIGENCE REVIEW &nbsp;&mdash;&nbsp; &euro;9,750 FOUNDING / &euro;12,950 LIST'), rule(),
 ...
 callout('<b>Why it is priced here.</b> This is the flagship and the reference product. At &euro;12,950 list it is roughly a quarter of what a mid-tier firm charges for less, delivered in a sixth of the time.', TEAL),
 PageBreak()]

b+=[L('3 &nbsp; TRANSACTION INTELLIGENCE &nbsp;&mdash;&nbsp; &euro;15,000 FOUNDING / &euro;19,500 LIST'), rule(),
...
b+=[L('4 &nbsp; INTELLIGENCE PARTNER &nbsp;&mdash;&nbsp; RETAINED'), rule(),
 ...
 simple_table(['Tier','Who it is for','Included','Founding','List'],[
  ['<b>Board Seat</b>','A board wanting the discipline available','1 Decision Brief per quarter, standing availability','<b>&euro;2,750/mth</b>','<b>&euro;3,750/mth</b>'],
  ['<b>Intelligence Partner</b>','An active board or a founder in a growth phase','1 Decision Brief per month, 1 Executive Review per year, board attendance by agreement','<b>&euro;4,500/mth</b>','<b>&euro;6,250/mth</b>'],
  ['<b>Chair&rsquo;s Counsel</b>','A chair or owner who wants John personally, continuously','Unlimited briefs within reason, all seven domains, direct access, board and ARC attendance','<b>&euro;7,500/mth</b>','<b>&euro;9,750/mth</b>'],
 ],[30*mm,38*mm,52*mm,25*mm,25*mm]),
 P('<b>Minimum twelve months. Quarterly in advance. Reviewed annually.</b>'),
 callout('<b>Why this tier matters more than any other.</b> It removes the sell. Line one has to win a new client every time. A retained seat compounds, it is predictable, and it is what makes Meridian a business rather than a series of engagements. <b>Three Intelligence Partner clients at list is &euro;225,000 a year before a single brief is sold.</b> That is the number to aim at.', TEAL),
 PageBreak()]
...
b+=[L('FUNDING OFFSETS &nbsp;&mdash;&nbsp; THE ENTRY ROUTE WORTH BUILDING'), rule(),
 P('<b>Enterprise Ireland Innovation Voucher, up to &euro;5,000.</b> At &euro;4,950 list, a Decision Brief is designed to sit exactly inside a single Innovation Voucher. That is a client acquiring a full Meridian brief at close to no net cost, which is the strongest possible first engagement.'),
 callout('<b>ACTION, worth doing this week:</b> confirm whether Meridian is, or can become, an Enterprise Ireland registered knowledge provider. Innovation Vouchers can only be redeemed against registered providers. If Meridian can register, this price point becomes a genuine market entry weapon. <b>UNVERIFIED until checked. Do not put it in front of a client before it is confirmed.</b>', RED, HexColor('#FBEDEF')),
 P('<b>Skillnet Ireland.</b> Applies to training-shaped delivery. Relevant to the Ambrion products rather than to Meridian&rsquo;s decision work, and it should follow those products across.'),
...
b+=[L('HOW TO PRESENT PRICE &nbsp;&mdash;&nbsp; FIVE RULES'), rule(),
 ...
 simple_table(['','Month 1','Month 2','Month 3'],[
  ...
  ['<b>Revenue</b>','<b>&euro;7,500</b>','<b>&euro;22,250</b>','<b>&euro;25,750</b>'],
 ],[45*mm,40*mm,42*mm,42*mm]),
 callout('Roughly <b>&euro;55,000 across the first quarter</b> at founding rates, with two retained clients carrying into the next one. A real business, built on a product set already proven nine times, and it does not require Meridian to be anyone&rsquo;s primary vehicle.', TEAL),
 ...
 N(2,'<b>Rename &ldquo;friends rate&rdquo; to &ldquo;founding client rate.&rdquo;</b> First ten clients, ends 31 December 2026.'),
 N(3,'<b>Check the Enterprise Ireland registered knowledge provider position this week.</b> It decides whether the Innovation Voucher route is real.'),
 ...
 Paragraph('Meridian Intelligence &middot; Products and pricing &middot; 5 August 2026 &middot; Private and confidential. Every product shape is drawn from work already delivered and filed in the Meridian repository. Prices are recommendations for John&rsquo;s decision, not yet set. The Enterprise Ireland Innovation Voucher route is UNVERIFIED pending confirmation of registered knowledge provider status. Velocity comparison pricing verified from the EDelia proposal, June 2026.', S['foot']),
]

build(OUT+'Meridian_Products_and_Pricing.pdf','Products and Pricing','The Go-to-Market Set',
      ['Built on the confirmed definition: Meridian is an executive intelligence practice',
       'Its product is the decision brief &middot; 5 August 2026'],
